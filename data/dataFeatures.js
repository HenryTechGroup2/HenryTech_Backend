function randomNumArray(length) {
  ...
  function generateProcessorRandomFeatures(procesadorBrand) {
    const processorFeatures = {
      product_processor_socket: procesadorBrand === 'Intel' ?
        ['1200 Comet Lake', '1700 Alder Lake-S', '1151 Coffe Lake'][randomNumArray(3)] :
      ...
      product_processor_base_frequency: ['3800 Mhz', '3700Mhz', '3600Mhz', '3400Mhz'][randomNumArray(4)],
      product_processor_max_frequency: ['4000 Mhz', '4100Mhz', '4200Mhz'][randomNumArray(3)],
      product_processor_gpu_chipset: ['NO Posee Gráficos Integrados', 'UHD Graphics 710', 'UHD Graphics 610'][randomNumArray(3)],
  ...
  function generateMotherboardRandomFeatures(motherboardBrand) {
    const motherboardFeatures = {
      product_motherboard_chipset: motherboardBrand === "AMD" ?
      ...
      product_motherboard_ethernet_board_speed: ['Gigabit LAN 10/100/1000 Mb/s', '2.5 Gigabit LAN 10/100/1000/2500', '2.5 Gb/s', '1 Gb/s'][randomNumArray(4)],
      ...
      product_motherboard_factor: ['M-ATX', 'ATX', 'ITX', 'E-ATX'][randomNumArray(4)],
      ...
      product_motherboard_consumption: ['10W', '30', '35', '50 W'][randomNumArray(4)],
      ...
      product_motherboard_audio_board: ['7.1 DAC Sabre Hi-Fi + ALC 4082', '7.1 Realtek ALC 887', '7.1 Realtek ALC 1220'][randomNumArray(3)]
    }
  ...
  function generateKeyboardRandomFeatures() {
    const keyboardFeatures = {
      product_keyboard_type: ['Completo', 'Compacto TKL', 'Compacto 60%'][randomNumArray(3)],
      product_keyboard_language: ['Español', 'Ingles'][randomNumArray(2)],
      product_keyboard_distribution: ['Latinoamerica', 'Internacional'][randomNumArray(2)],
      product_keyboard_colour: ['Blanco', 'Negro'][randomNumArray(2)],
      product_keyboard_material: ['Plástico', 'Aluminio'][randomNumArray(2)],
      product_keyboard_mechanism_type: ['Mecánico', 'Membrana', 'Semi Mecánico'][randomNumArray(3)],
      ...
      product_keyboard_bluetooth_receptor_includes: [true, false][randomNumArray(2)],
      product_keyboard_wireless_receptor_includes: [true, false][randomNumArray(2)],
      ...
      product_keyboard_weight: ['1.09 Kg', '1.05 Gg', '1.56Kg'][randomNumArray(3)],
      product_keyboard_wrist_rest: [true, false][randomNumArray(2)],
      product_keyboard_cable_type: ['Mallado de tela', 'Plastico'][randomNumArray(2)],
      product_keyboard_cable_removable: [true, false][randomNumArray(2)],
      product_keyboard_cable_length: ['1.8 metros', '1.2 metros', '1 metros'][randomNumArray(3)],
  ...
  function generateEarphoneRandomFeatures() {
    const earphoneFeatures = {
      ...
      product_earphone_speaker_diameter: ['20', '30', '32', '53', '40', '50'][randomNumArray(6)],
      product_earphone_compatibility: ['PC,PS4', 'PC,PS4,XBOX', 'PC,NINTENDO SWITCH'][randomNumArray(3)],
      product_earphone_dock_includes: [true, false][randomNumArray(2)],
      product_earphone_impedance: ['32 Ω', '42 Ω', '50 Ω'][randomNumArray(3)],
      product_earphone_min_frequency: ['15 Hz', '20 Hz', '30 Hz', '50 Hz'][randomNumArray(4)],
      product_earphone_max_frequency: ['20000 Hz', '18000 Hz', '15000 Hz', '19000 Hz'][randomNumArray(4)],
      product_earphone_sensitivity: ['91.7 db', '94.2 db', '106 db'][randomNumArray(3)],
      product_earphone_surround: [true, false][randomNumArray(2)],
      product_earphone_microphone_min_frequency: ['100 Hz', '125 Hz', '110 Hz', '105 Hz'][randomNumArray(4)],
      product_earphone_microphone_max_frequency: ['7000 Hz', '6000 Hz', '6500 Hz', '6700 Hz'][randomNumArray(4)],
      product_earphone_microphone_sensitivity: ['102 db', '93 db', '95 db', '110 db'][randomNumArray(4)],
      product_earphone_microphone_noise_canceling: [true, false][randomNumArray(2)],
      product_earphone_microphone_type: ['Desmontable', 'Retráctil', 'Integrado'][randomNumArray(3)],
      product_earphone_microphone_capture_type: ['Unidireccional', 'Omnidireccional', 'No especificado', 'Bidireccional'][randomNumArray(4)]
    }
  ...
  function generateMouseRandomFeatures() {
    const mouseFeatures = {
      ...
      product_mouse_sensor: ['Hero 25', 'Hero', 'Pixart PWM3389', 'Pixart Paw3370'][randomNumArray(4)],
      ...
      product_mouse_max_speed: ['400 ips', '350 ips', '450 ips'][randomNumArray(3)],
      ...
      product_mouse_dumbbells_weight: ['10 gr', '5 gr', '12 gr'][randomNumArray(3)],
      ...
      product_mouse_cable_length: ['1.8 Mts', '2 Mts', '2.5 Mts'][randomNumArray(3)],
  ...
  function generateDiskRandomFeatures() {
    const diskFeatures = {
      ...
      product_disk_rotation_speed: ['7200 RPM', '0 RPM', '6000 RPM'][randomNumArray(3)],
      product_disk_interface_speed: ['6.0', '5.0', '4.5'][randomNumArray(3)],
      product_disk_sequential_read_speed: ['500 Mb/s', '600 Mb/s', '650 Mb/s'][randomNumArray(3)],
      product_disk_sequential_write_speed: ['320 Mb/s', '400 Mb/s', '350 Mb/s'][randomNumArray(3)],
      product_disk_capacity: ['120 Gb', '240 Gb', '480 Gb', '1 Tb', '2 Tb'][randomNumArray(5)]
    }
    return diskFeatures;
  }
  function generateRamRandomFeatures() {
    const ramFeatures = {
      ...
      product_ram_speed: ['2666 Mhz', '2800 Mhz', '3000 Mhz', '3200 Mhz'][randomNumArray(4)],
  ...
  function generateDisplayRandomFeatures() {
    const displayFeatures = {
      ...
      product_display_maximum_consumption: ['70 W', '80 W', '100 W'][randomNumArray(3)],
      ...
      product_display_maximum_resolution: ['1366x768', '1920x1080', '2560x1440'][randomNumArray(3)],
      product_display_maximum_frequency: ['60 Hz', '144 Hz', '75 Hz'][randomNumArray(3)],
      ...
      product_display_weight_without_base: ['12.6 Kg', '14.1 Kg', '15.2 Kg'][randomNumArray(3)],
      product_display_remote_control: [true, false][randomNumArray(2)],
      product_display_cables_included: ['HDMI', 'Display Port', 'USB-C'][randomNumArray(3)]
    }
  ...
  function generatePowerSourceRandomFeatures() {
    const powerSourceFeatures = {
      product_power_sources_watts_nominal: ['850 W', '450 W', '650 W'][randomNumArray(3)],
      product_power_sources_real_watts: ['650 W', '450 W', '750 W'][randomNumArray(3)],
      product_power_sources_format: 'ATX',
      product_power_sources_compatible_with_bottom_position: [true, false][randomNumArray(2)],
      product_power_sources_80_plus_certification: ['80 PLUS Bronze', '80 PLUS Platinum', 'Standar'][randomNumArray(3)],
      product_power_sources_hybrid_mode: [true, false][randomNumArray(2)],
      product_power_sources_wiring_type: ['Cables fijos', 'Full modular'][randomNumArray(2)],
      product_power_sources_line_amps_12V: ['71 A', '28 A', '55 A'][randomNumArray(3)],
      ...
      product_power_sources_2_pin_pcie_plus_connector: [1, 2, 4][randomNumArray(3)],
      ...
      product_power_sources_includes_cable_a_220V: [true, false][randomNumArray(2)]
    }
  ...
  function generateWebcamRandomFeature() {
    const webcamFeatures = {
      product_webcam_maximum_video_resolution: ['1920×1080', '1280×1024', '1440×900'][randomNumArray(3)],
      product_webcam_video_max_resolution_type: ['HD', 'FULL HD', 'MAX HD'][randomNumArray(3)],
      product_webcam_camera_image_resolution: ['1920×1080', '1280×1024', '1440×900'][randomNumArray(3)],
      product_webcam_functions: ['Grabar', 'Grabar y fotografiar'][randomNumArray(2)],
      product_webcam_max_frames_per_second: ['45 FPS', '55 FPS', '60 FPS'][randomNumArray(3)],
      product_webcam_accessories_included: ['Tripode', 'Sin accesorios', 'Soporte monitor'][randomNumArray(3)],
      product_webcam_cable_length: ['1.8 Mts', '2 Mts', '2.5 Mts'][randomNumArray(3)],
  ...
  function generateMicrophoneRandomFeatures() {
    const microphoneFeatures = {
      ...
      product_microphone_microphone_formats: ['Omnidireccional', 'Unidireccional', 'Cardioide', 'Bidireccional'][randomNumArray(4)],
      product_microphone_microphone_types: ['Portatil', 'Fijo'][randomNumArray(2)],
      product_microphone_with_power_light: [true, false][randomNumArray(2)],
      product_microphone_types_of_connections: ['USB', 'USB - Type C'][randomNumArray(2)],
      product_microphone_input_connectors: ['3.5 mm', 'Sin conectores'][randomNumArray(2)],
      product_microphone_output_connectors: ['3.5mm'][randomNumArray(1)],
      product_microphone_accessories_included: ['Brazo de microfono', 'Tripode', 'Sin accesorios'][randomNumArray(3)]
    };
  ...
  function generateCoolerRandomFeatures() {
    const coolerFeatures = {
      ...
      product_cooler_maximum_speed: ['1600 rpm', '1500 rpm', '2000 rpm'][randomNumArray(3)],
      ...
      product_cooler_led_lights_color: ['Sin Iluminación', 'RGB', 'Rojo', 'Azul'][randomNumArray(4)],
      product_cooler_rgb_connection_system: ['Molex', 'Pines'][randomNumArray(2)],
      product_cooler_includes_hub_with_rgb_controller: [true, false][randomNumArray(2)]
    };
  ...
  function generateConsoleRandomFeatures() {
    const consoleFeatures = {
      ...
      product_console_accessories_included: ['Mando blanco', 'Mando negro'][randomNumArray(2)],
      product_console_console_type: ['Sobremesa', 'Portatil'][randomNumArray(2)],
      product_console_controlls_connectivities: ['Inalambrica', 'Cableada'][randomNumArray(2)],
      product_console_processor: ['Oberon', 'Oberon Plus', 'AMD Zen2'][randomNumArray(3)],
      product_console_gpu: ['RDNA 2 52 CUs', 'RDNA 2 36 CUs'][randomNumArray(2)],
      product_console_processor_speed: ['3.8 GHz', '4.0 GHz', '3.6 GHz'][randomNumArray(3)],
  ...
  function generateNotebookRandomFeatures() {
    const notebookFeatures = {
      ...
      product_notebook_operating_system: ['Windows 11 Home', 'Windows 10 Home', 'Windows 11 Pro'][randomNumArray(3)],
      ...
      product_notebook_gpu_model: ['RTX 3060', 'GTX 1650 Super', 'GTX 1660', 'RTX 2060'][randomNumArray(4)],
      product_notebook_cpu_model: ['Ryzen 9 4900HS', 'Core i7 11800H', 'Core i7 1165-G7'][randomNumArray(3)],
      ...
      product_notebook_processor_family: ['Intel Core i7', 'AMD Ryzen 7', 'Intel Core i9'][randomNumArray(3)],
      ...
      product_notebook_width: ['32.4 cm', '30.1 cm', '35.6 cm'][randomNumArray(3)],
      product_notebook_depth: ['22 cm', '31 cm', '26 cm'][randomNumArray(3)],
      product_notebook_heigth: ['1.99 cm', '1.23 cm', '2.34 cm'][randomNumArray(3)],
      ...
      product_notebook_screen_size: ['15.60 pulgadas', '19 pulgadas', '21.0 pulgadas'][randomNumArray(3)],
      ...
      product_notebook_keyboard_backligth_color: ['Blanco', 'Rojo', 'RGB'][randomNumArray(3)],
      ...
      product_notebook_ram_in_slot_1: ['8 Gb', '10 Gb', '16 Gb'][randomNumArray(3)],
      product_notebook_ram_in_slot_2: ['8 Gb', '10 Gb', '16 Gb'][randomNumArray(3)],
      product_notebook_memory_generation: ['DDR4', 'DDR3', 'DDR5'][randomNumArray(3)],
  ...
  function generateGpuRandomFeatures() {
    const gpuFeatures = {
      ...
      product_gpu_recomended_total_watts: ['450 W', '500 W', '650 W'][randomNumArray(3)],
      ...
      product_gpu_memory_speed: ['8000 mhz', '19000 mhz', '19500 mhz'][randomNumArray(3)],
      product_gpu_memory_type: ['GDDR6X', 'GDDR5X'][randomNumArray(2)],
      product_gpu_memory_capacity: ['6 Gb', '10 Gb', '8 Gb'][randomNumArray(3)],
      product_gpu_memory_interface: ['192 bits', '256 bits', '384 bits'][randomNumArray(3)],
      product_gpu_core_turbo_speed: ['1695 mhz', '1785 mhz', '1770 mhz'][randomNumArray(3)],
  ...
  function generateCabinetRandomFeatures() {
    const cabinetFeatures = {
      ...
      product_cabinet_window_type: ['Vidrio templado', 'Policarbonato'][randomNumArray(2)],
      ...
      product_cabinet_heigth: ['32.4 cm', '30.1 cm', '35.6 cm'][randomNumArray(3)],
      ...
      product_cabinet_supported_font_type: ['ITX', 'ATX', 'M-ATX'][randomNumArray(3)],
      product_cabinet_supported_80mm_fan_coolers: [0, 1, 2, 3, 4, 5][randomNumArray(6)],
      product_cabinet_80mm_fan_coolers_included: [0, 1, 2, 3, 4, 5][randomNumArray(6)],
      product_cabinet_supported_120mm_fan_coolers: [0, 1, 2, 3, 4, 5][randomNumArray(6)],
      product_cabinet_120mm_fan_coolers_included: [0, 1, 2, 3, 4, 5][randomNumArray(6)],
      product_cabinet_supported_140mm_fan_coolers: [0, 1, 2, 3, 4, 5][randomNumArray(6)],
      product_cabinet_140mm_fan_coolers_included: [0, 1, 2, 3, 4, 5][randomNumArray(6)],
      product_cabinet_supported_200mm_fan_coolers: [0, 1, 2, 3, 4, 5][randomNumArray(6)],
      product_cabinet_200mm_fan_coolers_included: [0, 1, 2, 3, 4, 5][randomNumArray(6)],
      product_cabinet_radiator_support_240mm: [0, 1, 2, 3, 4, 5][randomNumArray(6)],
      product_cabinet_radiator_support_280mm: [0, 1, 2, 3, 4, 5][randomNumArray(6)],
  ...
  export default function productsFeaturesSetter(products) {
    ...
    const productsWithFeatures = products.map((product) => {
      if (product.product_category === 'Procesadores') {
        const processorFeatures = generateProcessorRandomFeatures(product.product_brand);
        const newDataProcessor = { ...product, ...processorFeatures }
        return newDataProcessor;
      }
      if (product.product_category === 'Placas Madres') {
        const motherboardFeatures = generateMotherboardRandomFeatures(product.product_brand);
